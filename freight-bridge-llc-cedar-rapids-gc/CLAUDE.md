# Freight Bridge General Contracting - Cedar Rapids

This project was scaffolded by the [localevolve-factory](https://github.com/LocalEvolve/localevolve-factory) engine (v0.1.0, archetype: `mobile-service`).
